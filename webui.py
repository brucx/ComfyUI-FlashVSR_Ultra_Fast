...
def run_flashvsr_integrated(
    ...
    # Build a common dictionary for pipe arguments (only kwargs supported by Ultra_Fast pipelines)
    pipe_kwargs = {
    ...
    if tiled_dit:
        ...
        # Unified in-memory stitching for all modes (including tiny-long)
